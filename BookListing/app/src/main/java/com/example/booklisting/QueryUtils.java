...
/**
 * Helper methods related to requesting and receiving earthquake data from Google Book Api.
 */
    ...
    private static List<Book> extractFeatureFromJson(String bookJSON) {
        ...
        try {
            ...
            for (int i = 0; i < booksArray.length(); i++) {
                ...
                Book bookItem = new Book(title, author, amount, buyLink, currency, coverImageUrl );
